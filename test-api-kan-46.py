...
def run_tests():
    ...
    tests = [
        ...
        test_drivers_championship_happy_path,
        test_drivers_championship_not_found,
        test_drivers_championship_invalid_auth,
        test_constructors_championship_happy_path,
        test_constructors_championship_not_found,
        test_constructors_championship_invalid_auth,
    ]
    for test in tests:
        try:
            test()
